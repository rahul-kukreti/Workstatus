...
public class Member extends BaseClass {
	...
	@Test(testName = "For editing limit", priority = 28, enabled = true)
	public void Limit() {
	...
	@Test(testName = "For logout", priority = 31, enabled = true)
	public void logout() {
		member.logout(driver);
	}
	...
	@Test(testName = "For clear filter records", priority = 34, enabled = true)
